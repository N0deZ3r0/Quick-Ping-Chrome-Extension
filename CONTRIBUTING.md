...
Thanks for wanting to help. Quick Ping is a Chrome extension that shows network latency at a glance, and it is maintained
by one person — so a well-described issue is worth as much as a pull request.

## Reporting a bug

Open a [bug report](https://github.com/N0deZ3r0/Quick-Ping-Chrome-Extension/issues/new?template=bug_report.yml).
...
Откройте [баг-репорт](https://github.com/N0deZ3r0/Quick-Ping-Chrome-Extension/issues/new?template=bug_report.yml).
